...
import { petitProProductData } from '@/data/product';
...
export default function ProductProPage() {
  const [mainImage, setMainImage] = useState(petitProProductData.images[0]);
  const [openAccordion, setOpenAccordion] = useState<string | null>('description');
  const [quantity, setQuantity] = useState(1);
  const [openFaqIndex, setOpenFaqIndex] = useState<number | null>(null);
  const { addToCart } = useCart();

  const activeVariant = petitProProductData.variants[1]; // Petit is active on this page
          ...
          <div className={styles.heroGrid}>
            ...
            <div className={styles.galleryColumn}>
              <div className={styles.thumbnails}>
                {petitProProductData.images.map((img, idx) => (
                  <button
                    key={idx}
            ...
            <div className={styles.infoColumn}>
              <div className={styles.stickyContent}>
                <div className={styles.breadcrumb}>
                  <Link href="/">Home</Link> / <span>{petitProProductData.title}</span>
                </div>

                <div className={styles.reviews}>
                  <span className={styles.stars}>★★★★★</span>
                  <Link href="#reviews" className={styles.reviewText}>
                    {petitProProductData.rating} ({petitProProductData.reviewsCount.toLocaleString()} Reviews)
                  </Link>
                </div>

                <h1 className={styles.productTitle}>{petitProProductData.title}</h1>
                ...
                <p className={styles.shortDescription}>
                  {petitProProductData.shortDescription}
                </p>
                ...
                <div className={styles.variantSelector}>
                  {petitProProductData.variants.map((variant) => (
                    <Link
                      key={variant.id}
                      href={variant.href}
                ...
                <ul className={styles.featureList}>
                  {petitProProductData.features.map((feature, idx) => (
                    <li key={idx}>
                ...
                <div className={styles.addActions}>
                  <button
                    ...
                    onClick={() => addToCart({
                      id: petitProProductData.id,
                      title: petitProProductData.title,
                ...
                <div className={styles.accordions}>
                  {petitProProductData.accordions.map((acc) => (
